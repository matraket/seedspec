# Associated - Technical Documentation Generator v1.6
...
[1] RF ─→ [2] RNF-Base ─→ [3] DDD ─→ [4] ADRs ─→ [5] Stack ─→ [6] RNF-Tech ─→ [7] US/AC ─→ [8] UseCases
  ✅           ✅            ✅          ✅          ✅           🔜            ⬚           ⬚
KB-003       KB-004       KB-005      KB-006      KB-007     KB-004+007   RF+DDD+Stack   US+DDD
```
...
| 6 | RNF Técnicos | KB-004, KB-007 | `008_rnf-tecnicos.md` | 🔜 Pendiente |
...
### RNF-Tech Guidelines (Doc 6 - NEXT)
- Concretar RNFs agnósticos (KB-004) con tecnologías específicas (KB-007)
- Métricas específicas: tiempos de respuesta NestJS, bundle size React, queries PostgreSQL
- Configuraciones concretas: Prisma connection pool, Vite chunk splitting, Sentry sampling
- Referenciar RNF base + tecnología que lo implementa
...
## Current State
- **Versión Instructions:** 1.6
- **Documentos generados:** 5/8
- **Último completado:** [5] Stack Tecnológico (TypeScript, NestJS, React, PostgreSQL)
- **Siguiente:** [6] RNF Técnicos
- **Inputs disponibles:** ✅ KB-004, ✅ KB-007
