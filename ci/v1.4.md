# Associated - Technical Documentation Generator v1.4
...
[1] RF ─→ [2] RNF-Base ─→ [3] DDD ─→ [4] ADRs ─→ [5] Stack ─→ [6] RNF-Tech ─→ [7] US/AC ─→ [8] UseCases
  ✅           ✅            ✅          🔜          ⬚           ⬚            ⬚           ⬚
KB-003       KB-004       KB-005     KB-004+005  ADRs+RNF   Stack-dep    RF+DDD+Stack   US+DDD
```
...
| 4 | ADRs Arquitectura | KB-004, KB-005 | `006_adrs.md` | 🔜 Pendiente |
...
### ADR Guidelines (Doc 4 - NEXT)
- Decisiones arquitectónicas derivadas de RNFs + modelo de dominio
- Formato: Contexto → Decisión → Consecuencias
- Mínimo: arquitectura general, persistencia, comunicación entre BCs, autenticación
- Referenciar RNFs que justifican cada decisión
- Considerar RNF-004 (multi-tenant por BD) como decisión clave
...
## Current State
- **Versión Instructions:** 1.4
- **Documentos generados:** 3/8
- **Último completado:** [3] Bounded Contexts + Modelo de Dominio (6 BCs, 18 Aggregates)
- **Siguiente:** [4] ADRs Arquitectura
- **Inputs disponibles:** ✅ KB-004, ✅ KB-005
