# Associated - Technical Documentation Generator v1.5
...
[1] RF ─→ [2] RNF-Base ─→ [3] DDD ─→ [4] ADRs ─→ [5] Stack ─→ [6] RNF-Tech ─→ [7] US/AC ─→ [8] UseCases
  ✅           ✅            ✅          ✅          🔜           ⬚            ⬚           ⬚
KB-003       KB-004       KB-005      KB-006    KB-004+006  Stack-dep    RF+DDD+Stack   US+DDD
```
...
| 5 | Stack Tecnológico | KB-004, KB-006 | `007_stack.md` | 🔜 Pendiente |
| 6 | RNF Técnicos | [5], KB-004 | `008_rnf-tecnicos.md` | ⬚ |
| 7 | User Stories + AC | KB-003, KB-005, MVP scope | `009_user-stories.md` | ⬚ |
...
**Decisiones clave para Stack:**
- ADR-001: Monolito modular → un único artefacto desplegable
- ADR-005: PostgreSQL como RDBMS
- ADR-009: Clean Architecture (Infrastructure → Application → Domain)
- ADR-010: API REST
- ADR-011: S3-compatible storage
...
### Stack Guidelines (Doc 5 - NEXT)
- Selección de tecnologías justificada por ADRs
- Para cada tecnología: nombre, versión, justificación, alternativas descartadas
- Categorías: Backend, Frontend, Base de datos, Infraestructura, Testing, DevOps
- Referenciar ADRs que condicionan cada elección
- Considerar: PostgreSQL (ADR-005), API REST (ADR-010), Clean Architecture (ADR-009)
...
## Current State
- **Versión Instructions:** 1.5
- **Documentos generados:** 4/8
- **Último completado:** [4] ADRs Arquitectura (12 ADRs)
- **Siguiente:** [5] Stack Tecnológico
- **Inputs disponibles:** ✅ KB-004, ✅ KB-006
